...
const administradorRoutes_1 = __importDefault(
  require("./routes/administradorRoutes")
);
const MotivoPausaRoutes_1 = __importDefault(
  require("./routes/MotivoPausaRoutes")
);
...
const PuestoTrabajadorRoutes_1 = __importDefault(
  require("./routes/PuestoTrabajadorRoutes")
);

...
let AdministradorFormComponent = class AdministradorFormComponent {
    constructor(administradorservices, router, activatedRouter) {
    ...
    ngOnInit() {
        ...
        if (params.id) {
            this.administradorservices.getAdministrador(params.id).subscribe(res => {
                console.log(res);
    ...
    saveNewAdministrador() {
        ...
        if (this.administrador.Password == this.RepetirPassword) {
            this.error = false;
            this.administradorservices.saveAdministrador(this.administrador).subscribe(res => {
                console.log(res);
    ...
    updateAdministrador() {
        ...
        if (this.administrador.Password == this.RepetirPassword) {
            this.error = false;
            this.administradorservices.updateAdministrador(this.administrador.IdAdmin, this.administrador).subscribe(res => {
                console.log(res);
                this.router.navigate(['/administrador']);
            }, err => console.error(err));
        }
...
AdministradorFormComponent.ctorParameters = () => [
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
 ...
 //
let AdministradorListComponent = class AdministradorListComponent {
    ...
    getAdministradores() {
        this.administradorService.getAdministradores().subscribe(res => {
            ...
            console.log(res);
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.administradores);
    ...
    deleteAdministrador() {
        this.administradorService.deleteAdministrador(this.administrador_modal.IdAdmin).subscribe(res => {
            console.log(res);
            this.getAdministradores();
...
AdministradorListComponent.ctorParameters = () => [
    { type: _services_administrador_administrador_service__WEBPACK_IMPORTED_MODULE_2__["AdministradorService"] }
];
...
let NavigationComponent = class NavigationComponent {
    constructor(authServiceLogin, router) {
...
let OperadorFormComponent = class OperadorFormComponent {
    constructor(operadorService, router, activatedRouter, puestoTrabajadorService) {
    ...
    ngOnInit() {
        ...
        console.log(params);
        if (params.id) {
            this.operadorService.getOperador(params.id).subscribe(res => {
                console.log(res);
                this.operador = res;
                this.update = true;
    ...
    saveNewOperador() {
        ...
        this.operadorService.saveOperador(this.operador).subscribe(res => {
            console.log(res);
            this.habilitado = true;
    ...
    updateOperador() {
        ...
        console.log(this.operador);
        this.operadorService.updateOperador(this.operador.IdOperador, this.operador).subscribe(res => {
            console.log(res);
            this.router.navigate(['/operador']);
        }, err => console.error(err));
    }
    getPuestos() {
        console.log('entro');
        this.puestoTrabajadorService.getPuestosTrabajador().subscribe(res => {
            this.puestos = res;
...
OperadorFormComponent.ctorParameters = () => [
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
 ...
 //
let OperadorListComponent = class OperadorListComponent {
    ...
    getOperadores() {
        this.operadorService.getOperadores().subscribe(res => {
            ...
            console.log(res);
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.operadores);
            this.dataSource.paginator = this.paginator;
        }, err => { console.error(err); }, () => {
            this.dataSource.filterPredicate = this.customFilterPredicate();
            console.log(this.customFilterPredicate());
    ...
    deleteOperador() {
        this.operadorService.deleteOperador(this.operador_modal.IdOperador).subscribe(res => {
            console.log(res);
            this.getOperadores();
        }, err => console.error('el error es: ' + err));
    }
...
OperadorListComponent.ctorParameters = () => [
    { type: _services_operador_operador_service__WEBPACK_IMPORTED_MODULE_2__["OperadorService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_paginator__WEBPACK_IMPORTED_MODULE_4__["MatPaginator"], { static: true })
...
let OperadorPantallaComponent = class OperadorPantallaComponent {
    ...
    constructor(operadorService, motivopausaService, trabajoService, otService, pausaService, tiempoService) {
        this.operadorService = operadorService;
    ...
    getMotivoPausa() {
        this.motivopausaService.getMotivoPausas().subscribe(res => {
    ...
    msToTime(duration) {
        ...
        let hours = Math.floor((duration / (1000 * 3600)) % 25);
    ...
    IniciarOt() {
        if (this.codigoIngresado == undefined || this.codigoIngresado == '') {
            ...
            let ottrabajdor = new _models_OtTrabajador__WEBPACK_IMPORTED_MODULE_3__["OtTrabajador"]();
    ...
    iniciarPausa() {
        if (this.motivoSeleccionado != undefined && this.idMotivoSeleccionado != undefined) {
            let pausa = new _models_Pausa__WEBPACK_IMPORTED_MODULE_5__["Pausa"]();
    ...
    cerrarOtFuncionalidad(index, deDondeEsLlamado) {
        console.log('------------------------------------------------');
        console.log('------------------------------------------------');
        ...
        let objTiempo = new _models_Tiempo__WEBPACK_IMPORTED_MODULE_9__["Tiempo"]();
        ...
        res => {
            ...
            if (res == 'no existe') {
                ...
                this.otService.saveOt(this.otParaGuardar).subscribe(res => {
                    console.log(res);
                    ...
                    this.otService.getOtByCodigo(this.codigoparabuscarot).subscribe(res => {
                        ...
                        console.log(this.listOtIngresadas[index]);
                        this.trabajoService.saveTrabajo(this.listOtIngresadas[index]).subscribe(res => {
                            ...
                            for (let i = 0; i < this.listPausas.length; i++) {
                                ...
                                this.pausaService.savePausa(this.listPausas[i]).subscribe(res => {
                                    ...
                                    this.trabajoService.updateTotalTiempo(idtrabajofinal, this.otTrabajadorparaActualizar).subscribe(res => {
                            ...
                            for (let j = 0; j < this.listTiempo.length; j++) {
                                ...
                                if (this.listTiempo[j].IdOperador == this.variableidoperadorencerrarjornadamodal) {
                                    ...
                                    this.tiempoService.saveTiempo(this.listTiempo[j]).subscribe(res => {
                                        console.log(res);
                                        this.listTiempo.splice(j, 1);
                                    }, err => console.error(err));
                                }
                        ...
                        for (let j = 0; j < this.listTiempo.length; j++) {
                            ...
                            if (this.listTiempo[j].IdOperador == idoperadorsegunelmetododesdeelcualesllamado) {
                                ...
                                this.tiempoService.saveTiempo(this.listTiempo[j]).subscribe(res => {
                                    ...
                                    this.trabajoService.updateTotalTiempo(idotparaactualizarenfortiempos, this.otTrabajadorparaActualizar).subscribe(res => {
                                        console.log('actualizado nuevo total tiempo de trabajo!');
                                        console.log(this.otTrabajadorparaActualizar);
    ...
    cerrarPausadesdemodalcerrarjornada(id) {
        for (let index = 0; index < this.listPausas.length; index++) {
    ...
    mostrarmensajecerrarjornadaoreiniciardatosmodalcerrarjornada() {
        ...
        let mostrarmensajecerrarjornada = true;
...
OperadorPantallaComponent.ctorParameters = () => [
    { type: _services_operador_operador_service__WEBPACK_IMPORTED_MODULE_2__["OperadorService"] },
...
let OtFormComponent = class OtFormComponent {
    constructor(otservices, router, activatedRouter) {
    ...
    ngOnInit() {
        ...
        console.log(params);
        if (params.id) {
            this.otservices.getOt(params.id).subscribe(res => {
                console.log(res);
                this.ot = res;
                this.update = true;
                this.codigo = true;
    ...
    saveNewOt() {
        delete this.ot.IdOt;
        this.error = false;
        this.otservices.saveOt(this.ot).subscribe(res => {
            console.log(res);
            this.habilitado = true;
    ...
    updateOt() {
        console.log(this.ot);
        this.error = false;
        this.otservices.updateOt(this.ot.IdOt, this.ot).subscribe(res => {
            console.log(res);
            this.router.navigate(['/ot']);
        }, err => console.error(err));
    }
...
OtFormComponent.ctorParameters = () => [
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
 ...
 //
let OtListComponent = class OtListComponent {
    //
    constructor(otService, trabajoService) {
        this.otService = otService;
        this.trabajoService = trabajoService;
    ...
    //
    getOts() {
        this.otService.getOts().subscribe(res => {
            this.ots = res;
            console.log('getOts');
            console.log(res);
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.ots);
            this.dataSource.paginator = this.paginator;
        }, err => { console.error(err); }, () => {
            this.dataSource.filterPredicate = this.customFilterPredicate();
            console.log(this.customFilterPredicate());
    ...
    closeOt() {
        this.otService.closeOt(this.id).subscribe(res => {
            console.log('res');
            console.log(res);
            this.getOts();
        }, err => console.error('el error es: ' + err));
    ...
    agregarHP() {
        ...
        this.otService.updateOt(this.id, this.ot).subscribe(res => {
            console.log(res);
            this.getOts();
        }, err => { console.error(err); }, () => {
        });
...
OtListComponent.ctorParameters = () => [
    { type: _services_ot_ot_service__WEBPACK_IMPORTED_MODULE_2__["OtService"] },
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
 ...
 //
let PausaListComponent = class PausaListComponent {
    constructor(pausaService) {
        this.pausaService = pausaService;
    ...
    getPausas() {
        this.pausaService.getPausas().subscribe(res => {
            this.pausas = res;
            console.log('getPausas');
            console.log(res);
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.pausas);
            this.dataSource.paginator = this.paginator;
        }, err => { console.error(err); }, () => {
            this.dataSource.filterPredicate = this.customFilterPredicate();
        });
...
PausaListComponent.ctorParameters = () => [
...
let TrabajoListComponent = class TrabajoListComponent {
    constructor(trabajoService, tiempoService, otService) {
        this.trabajoService = trabajoService;
        this.tiempoService = tiempoService;
        this.otService = otService;
    ...
    getTrabajos() {
        ...
        this.trabajoService.getTrabajos().subscribe(res => {
            ...
            console.log(res);
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.trabajos);
            this.dataSource.paginator = this.paginator;
        }, err => { console.error(err); }, () => {
            this.dataSource.filterPredicate = this.customFilterPredicate();
        });
    ...
    updateTrabajo() {
        ...
        this.trabajoService.verificarExisteOt(this.ot.Codigo).subscribe(res => {
            console.log(res);
            if (res != "no existe") {
                this.trabajoModificar.IdOt = res;
                this.trabajoService.updateCodigoTrabajo(this.idTrabajoAmodificar, this.trabajoModificar).subscribe(res => {
                    this.getTrabajos();
                    console.log(res);
                }, err => { console.log(err); });
            }
                ...
                this.otService.saveOtandReturnId(this.otModificar).subscribe(res => {
...
TrabajoListComponent.ctorParameters = () => [
...
class MatPaginatorIntlEsp extends _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginatorIntl"] {
    constructor() {
        super(...arguments);
        this.itemsPerPageLabel = 'Items por pagina';
        this.nextPageLabel = 'Siguiente pagina';
        this.previousPageLabel = 'Pagina previa';
...
let MotivopausaService = class MotivopausaService {
    constructor(http) {
        this.http = http;
...
MotivopausaService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let PausaService = class PausaService {
    constructor(http) {
        this.http = http;
        this.API_URI = "http://localhost:3000/api"; //ruta api en server
    }
...
let PuestotrabajadorService = class PuestotrabajadorService {
    constructor(http) {
        this.http = http;
        this.API_URI = "http://localhost:3000/api"; //ruta api en server
    }
    getPuestosTrabajador() {
        return this.http.get(`${this.API_URI}/puestoTrabajador`);
    }
};
PuestotrabajadorService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let TiempoService = class TiempoService {
    constructor(http) {
        this.http = http;
        this.API_URI = "http://localhost:3000/api"; //ruta api en server
    }
...
let TrabajoService = class TrabajoService {
    ...
    // }
    updateCodigoOt(IdOt, updatedOt) {
        console.log('id ot es: ' + IdOt);
        return this.http.put(`${this.API_URI}/ot/${IdOt}`, updatedOt);
    }
    verificarCodigoOt(Codigo) {
    ...
    verificarExisteOt(Codigo) {
        console.log('metodo verificarCodigoOt de trabajoservice');
        console.log('codigo ot es: ' + Codigo);
        return this.http.get(`${this.API_URI}/ot/verificarOt/${Codigo}`);
    }
    updateTotalTiempo(IdTrabajo, TotalTiempo) {
...
module.exports = __webpack_require__(/*! C:\Users\Felipe\Desktop\Proyecto\client\src\main.ts */"./src/main.ts");
